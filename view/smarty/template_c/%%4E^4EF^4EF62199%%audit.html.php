<?php /* Smarty version 2.6.26, created on 2014-08-15 21:15:47
         compiled from manage/audit.html */ ?>
...
/commonUtils/getAuditRecords"+"?streamNumber="+stream_number+"&auditOper=none";
...
"+"&";
            ...
            $('#tableInfo').html( "当前范围：" + showLowerBound + "~" + showUpperBound + "/ 共" + count + "条数据，查看【<a href='<?php echo $this->_tpl_vars['base_url']; ?>
/manage'>最新数据</a>】");
        });
    </script>
    <script type="text/javascript">
